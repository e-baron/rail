# 1. Analyse des exigences critiques du KB "Infra"
...
# 2. Critères d'acceptation des risques

## 2.1 Généralités 

Conformément à la CSM et à EN 50126, dans les analyses de sécurité, il doit être vérifié que chaque danger est adéquatement couvert par :
...
## 2.2 Identification des Safety Targets

### 2.2.1 Introduction

Pour chaque changement associé à un système de signalisation qui doit être certifié selon les normes CENELEC, les **Safety Targets** sont identifiés conformément à **EN 50126‑2**, en s’appuyant sur l’une ou une combinaison des approches ci‑dessous, selon le contexte et la disponibilité des données.


### 2.2.2 Approches permises pour l’acceptabilité du risque

#### 2.2.2.1. Application de règles de l’art / normes reconnues
...
- Par exemple, la norme **NBN EN 16704-2-1:2016 Applications ferroviaires - Voie - Protection et sécurité durant des travaux sur la voie - Partie 2-1: Solutions communes et technologie - Exigences relatives aux dispositifs d'annonce des circulations (TWS)** fournit des Safety targets pour l'ATWS : Un TFFR de 1,14 × 10−8 par heure et un développement SIL3.  


#### 2.2.2.2. Matrice d’acceptation des risques (approche hybride)
...
#### 2.2.2.3. Approche basée sur les statistiques d’accidents / incidents
...
#### 2.2.2.4. Jugement d’expert structuré
...
### 2.2.3 Suite du processus (commune à toutes les approches)
...
### 2.2.4 Synthèse visuelle : critères d'acceptation des risques
...
flowchart TD
    ...
    A[Changement système de signalisation]

    A --> B{Danger identifié}
    B --> C{Couverture du danger}

    C -->|Règles de l’art / Normes| D1[Acceptabilité démontrée]
    C -->|Système de référence GAME| D1
    ...
    E1 --> F[Acceptabilité du risque TAR]
    E2 --> F
    E3 --> CH{Choix des objectifs}

    F --> G[Safety Targets : THR réseau par danger]

    G --> H[Allocation THR vers projet]
    H --> I[Analyse causale du danger]
