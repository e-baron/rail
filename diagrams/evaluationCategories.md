...
| **(TYP13 - DMC)** Déploiement de la modification d'un système de référence certifié | L’un des critères ci-dessous est rempli :<br>(1) Utilisation pour la première fois dans un projet du BSL et du PTR génériques SM400T mis à niveau.<br>(2) Impact sur les principes fondamentaux de signalisation.<br>(3) Impact sur les interfaces IL‑PLP vers les produits périphériques et/ou les nouveaux produits périphériques tels que AW, ACAT, CV.SK, EBP, RBC, etc. |  TSI-1, TSI1 (Only if change of Interoperability constituents part of a PLP project such as ACAT, CV.SK or any other PLP project where STI requirements apply) | Oui (si TSI1) | CSM2, CSM3, CSM4 | Oui (si CSM3/4) | CEN3 | Oui | CAT3 |
|  | Changement significatif du BSL générique IL.PLP nécessitant une nouvelle ligne pilote. Cela inclut un nouveau produit cœur PLP remplaçant le CIXL, le Smart GW ou le TFM. | TSI-1, TSI1 (Only if change of Interoperability constituents part of a PLP project such as ACAT, CV.SK or any other PLP project where STI requirements apply) | Oui (si TSI1) | CSM3, CSM4 | Oui | CEN3 | Oui | CAT4 |
