...
| **(TYP13 - DMC)** Déploiement de la modification d'un système de référence certifié | Déviations mineures aux exigences génériques ou exigences spécifiques mineures : TBC | (TSI0?) TSI1  | Oui? | CSM2 | Non | CEN3 | Oui | CAT3 |
| | 1ère application d'une nouvelle baseline Generic ETCS **mineure** | (TSI0?) TSI1 | Oui? | CSM2 | Non | CEN3 | Oui | CAT3 |
|  | Déviations majeures aux exigences génériques ou exigences spécifiques majeures : TBC | TSI1 | Oui | CSM3 | Oui | CEN3 | Oui | CAT3 |
